...
#define LOG_DEBUG_DEFAULT LOG_DEBUG(dying::SingletonLoggerManager::getInstance().getLogger("DEBUG"))

#define LOG_INFO(logger)  LOG_LEVEL(logger , dying::LogLevel::INFO)
#define LOG_INFO_DEFAULT  LOG_INFO(dying::SingletonLoggerManager::getInstance().getLogger("INFO"))

#define LOG_WARN(logger)  LOG_LEVEL(logger , dying::LogLevel::WARN)
#define LOG_WARN_DEFAULT  LOG_WARN(dying::SingletonLoggerManager::getInstance().getLogger("WARN"))

#define LOG_ERROR(logger) LOG_LEVEL(logger , dying::LogLevel::ERROR)
#define LOG_ERROR_DEFAULT LOG_ERROR(dying::SingletonLoggerManager::getInstance().getLogger("ERROR"))

#define LOG_FATAL(logger) LOG_LEVEL(logger , dying::LogLevel::FATAL)
#define LOG_FATAL_DEFAULT LOG_FATAL(dying::SingletonLoggerManager::getInstance().getLogger("FATAL"))
...
#define LOG_FMT_DEBUG_DEFAULT(fmt , ...)  LOG_FMT_DEBUG(dying::SingletonLoggerManager::getInstance().getLogger("DEBUG") , fmt , __VA_ARGS__)

#define LOG_FMT_INFO(logger , fmt , ...)  LOG_FMT_LEVEL(logger , dying::LogLevel::INFO  , fmt , __VA_ARGS__)
#define LOG_FMT_INFO_DEFAULT(fmt , ...)   LOG_FMT_INFO(dying::SingletonLoggerManager::getInstance().getLogger("INFO") , fmt , __VA_ARGS__)

#define LOG_FMT_WARN(logger , fmt , ...)  LOG_FMT_LEVEL(logger , dying::LogLevel::WARN  , fmt , __VA_ARGS__)
#define LOG_FMT_WARN_DEFAULT(fmt , ...)   LOG_FMT_WARN(dying::SingletonLoggerManager::getInstance().getLogger("WARN") , fmt , __VA_ARGS__)

#define LOG_FMT_ERROR(logger , fmt , ...) LOG_FMT_LEVEL(logger , dying::LogLevel::ERROR , fmt , __VA_ARGS__)
#define LOG_FMT_ERROR_DEFAULT(fmt , ...)  LOG_FMT_ERROR(dying::SingletonLoggerManager::getInstance().getLogger("ERROR") , fmt , __VA_ARGS__)

#define LOG_FMT_FATAL(logger , fmt , ...) LOG_FMT_LEVEL(logger , dying::LogLevel::FATAL , fmt , __VA_ARGS__)
#define LOG_FMT_FATAL_DEFAULT(fmt , ...)  LOG_FMT_FATAL(dying::SingletonLoggerManager::getInstance().getLogger("FATAL") , fmt , __VA_ARGS__)

/**
 * @brief 获取主日志器
 */
#define LOG_ROOT() dying::LoggerMgr::GetInstance()->getRoot()

/**
 * @brief 获取name的日志器
 */
#define LOG_NAME(name) dying::LoggerMgr::GetInstance()->getLogger(name)
