...
namespace dying{
    ...
    void Logger::setFormatter(const std::string &val) {
        ...
        dying::LogFormatter::ptr  new_val(new dying::LogFormatter(val));
        if(new_val->isError()){
    ...
    void FileLogAppender::log(std::shared_ptr<Logger> logger, dying::LogLevel::Level level, LogEvent::ptr event) {
        if(level >= m_level){
...
class MessageFormatItem : public LogFormatter::FormatItem{
    public:
        ...
        void format(std::ostream &os, std::shared_ptr<Logger> logger, dying::LogLevel::Level level, LogEvent::ptr event) override{
            os << event->getContent();
        }
    };
...
#undef XX
    ...
    SingletonLoggerManager::SingletonLoggerManager() {
    ...
    SingletonLoggerManager &SingletonLoggerManager::getInstance() {
        static SingletonLoggerManager manager ;
        return manager;
    }

    void SingletonLoggerManager::close() {
        m_isclose = true;
